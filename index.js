...
function mainLoop(){
    ...
    for(var i=0;i<playersClient.length;i++){
        playersServer[i].posx+=((playersClient[i].mousePosx-playersServer[i].posx)/100000)*delta;
        playersServer[i].posy+=((playersClient[i].mousePosy-playersServer[i].posy)/100000)*delta;
